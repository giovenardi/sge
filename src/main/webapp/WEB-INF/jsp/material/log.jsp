...
<template:admin>
	<jsp:body>
		<div class="ui small breadcrumb">
			...
			<i class="right arrow icon divider"></i>
			<a class="section" href="<c:url value='/material/historico/${auditoria.objectId}'/>">Histórico</a>
			<i class="right arrow icon divider"></i>
			<div class="active section">Log</div>
		</div>
		<div class="ui grid">
			<div class="eight wide column">
				<div class="twelve wide column"><h2 class="ui header" style="padding-top: 10px">Log do Material</h2></div>
			</div>
			<div class="eight wide column">
				<div  style="float: right">
				<div class="ui icon buttons"><a target="_blank" class="ui cinza button" href="<c:url value='/material/imprimirLog/${auditoria.id}/${descricao}'/>" data-content="Imprimir"><i class="print icon"></i></a></div>
				</div>
			</div>	
		</div>
		<hr> 
