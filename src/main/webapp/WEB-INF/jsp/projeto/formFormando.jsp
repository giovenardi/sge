...
<div class="ui small modal" id="modalFormando">
    ...
    <form role="form" id="formFormando" method="POST" action='<c:url value="/formando/salvar"/>'>
		<input name="formando.id" type="hidden" value="${formando.id}">
	    <div class="content">
			<div class="ui segment">
				<div class="ui form">
			    	<lummi:pf label="Nome" obrigatorio="true" prefixo="formando" funcao="inserirPessoaFormando()"/>
					...
					<div class="fields">
						...
						<input type="hidden" id="taxaBoletoFormando" name="formando.taxaBoleto" value="${formando.taxaBoleto}">
				 		...
				 		<div class="three wide field">
							...
							<input type="text" maxlength="2" class="campo-form numero2" name="formando.numeroHavana" value='${formando.numeroHavaiana}'>
						</div>
				 		<div class="three wide field">
							<label>Dia Pagamento</label>
							<input type="text" maxlength="2" class="campo-form numero2" name="formando.numeroHavaana" value='${formando.numeroHavaiana}'>
						</div>
					</div>
				</div>
			</div>
		    <div class="actions" style="text-align: center"> 
      			...
      			<a id="btnProdutos" class="ui gold inverted button" href="#"><i class="dollar icon"></i>Produtos</a>
				</div>
		</div>
	</form>
</div>