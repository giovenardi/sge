...
<template:admin>
    ...
    <jsp:body>
		...
		<div class="ui top attached tabular menu">
		  ...
		  <a class="item" data-tab="planilha_tab">Planilha de Vantagens</a>
		  <a class="item" data-tab="eventos_tab">Eventos</a>
		  <a class="item" data-tab="planos_tab">Planos</a>
		  <a class="item" data-tab="formandos_tab">Formandos</a>
		  <a class="item" data-tab="levantamento_tab">Levantamento</a>
		</div>
