...
<div class="ui small modal" id="modalMembro">
    <div class="ui icon header" id="tituloModalMembro">
    	<i class="glyphicon glyphicon-education pencilNovo"></i>
      	Incluir um Membro
    </div>
    <form role="form" id="formMembro" method="POST" action='<c:url value="/turma/incluir"/>'>
	    <div class="content">
	    ...
	    <div class="actions" style="text-align: center"> 
	      	...
	      	<a id="btnConfirmMembro" class="ui green ok inverted button" href="#">
