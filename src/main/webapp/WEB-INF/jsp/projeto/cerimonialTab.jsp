...
<div class="ui bottom attached tab segment" data-tab="cerimonial_tab">
	<form id="formCerimonial" role="form" action="<c:url value='/cerimonial/salvar'/>" method="POST">
		...
		<input name="cerimonial.valorExcedenteCerimonial" id="cerimonialValorConvidadoExtra" type="hidden" value="<fmt:formatNumber value="${projeto.cerimonial.valorExcedenteCerimonial}" minFractionDigits="2" maxFractionDigits="2"></fmt:formatNumber>">
		...
		<div class="ui form">
			<div class="fields separador">
		 		...
		 		<div class="three wide field">
					<label>Valor Excedente Cerimonial</label>
					<input type="text" maxlength="18" id="maskedCerimonialValorConvidadoExtra"  class="campo-form dinheiro" value="<fmt:formatNumber value="${projeto.cerimonial.valorExcedenteCerimonial}" type="currency"></fmt:formatNumber>">
				</div>
 				<div class="three wide field">
