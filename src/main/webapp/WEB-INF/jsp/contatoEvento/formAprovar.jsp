...
<div class="ui small modal" id="modalAprovar">
    <div class="ui icon header">
    	<i class="glyphicon glyphicon-thumbs-up"></i>
      	Aprovar Contato
    </div>
    <form role="form" id="formAprovar" method="POST" action='<c:url value="/contatoEvento/aprovar"/>'>
	    <div class="content">
	    ...
	    <div class="actions" style="text-align: center"> 
	      	...
	      	<a id="btnConfirmAprovar" class="ui green ok inverted button" href="#">
	        	<i class="glyphicon glyphicon-thumbs-up"></i>
	        	Aprovar
	      	</a>
		</div>
