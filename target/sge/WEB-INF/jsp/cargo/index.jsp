	...
	<jsp:attribute name="extraStyles">
 	...
 	<jsp:body>
 		...
 		<div class="ui small breadcrumb">
			  ...
			  <div class="active section">Cargos</div>
 		</div>
 		<div class="ui grid">
			...
			<tbody>
				<c:forEach items="${paginatedList.currentList}" var="det" varStatus="count">
					<tr class="cell-content-selectable">
						<td onclick="modalLoading();location.href='<c:url value='/cargo/show/${det.id}'/>';">${det.id}</td>
						<td onclick="modalLoading();location.href='<c:url value='/cargo/show/${det.id}'/>';">${det.nome}</td>
						<td>
							<div class="ui icon buttons">
